...
export default function EnglishHomePage() {
  return (
    <main className="bg-[#050505] text-[#f7f3e8]">
      ...
      <section className="relative min-h-[52rem] overflow-hidden border-b border-white/[0.06] lg:min-h-screen">
        ...
        <div className="page-shell relative z-10 grid min-h-[52rem] items-center gap-12 pb-14 pt-32 lg:min-h-screen lg:grid-cols-[minmax(0,.9fr)_minmax(28rem,1.1fr)] lg:gap-14 lg:pt-28">
          ...
          <div className="relative aspect-[3/2] w-full overflow-hidden rounded-[1.75rem] border border-white/[0.08] bg-[#121311] shadow-[0_32px_90px_rgba(0,0,0,.48)]">
            <Image src="/FSwithTheBook.webp" alt="Dr. Ferdoush Saleheen holding his book on Surah Al-Fatihah" fill priority sizes="(max-width: 1024px) 100vw, 48vw" className="object-cover object-center" />
      ...
      <section className="border-b border-white/[0.06] bg-[#0a0a09]"><div className="page-shell grid gap-8 py-8 md:grid-cols-[auto_1fr_auto] md:items-center"><div className="flex items-center gap-4"><div className="relative size-14 overflow-hidden rounded-full border border-[#d6a642]/30"><Image src="/fsPhoto.webp" alt="Portrait of Dr. Ferdous Saleheen" fill sizes="56px" className="object-cover" /></div><div><strong className="block text-sm font-medium">Dr. Ferdoush Saleheen</strong><span className="text-xs text-[#858178]">PhD · FCILT</span></div></div><p className="max-w-2xl text-sm leading-6 text-[#99958c] md:border-l md:border-white/10 md:pl-8">Supply chain and logistics specialist, academic, researcher, and author of Surah Al-Fatihah: The Seven Verses.</p><Link href="/en/about" className="inline-flex items-center gap-2 text-sm text-[#d6a642]">Read profile <ArrowRight className="size-4" /></Link></div></section>
