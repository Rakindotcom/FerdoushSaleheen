...
const exploreItems = [
  ...
  { icon: BookOpen, number: "02", title: "Publications", description: "Academic supply-chain scholarship and Dawah writing, clearly separated.", href: "/en/books" },
...
export default function EnglishHomePage() {
  return (
    <main className="bg-[#050505] text-[#f7f3e8]">
      ...
      <section className="border-b border-white/[0.06] bg-[#0a0a09]"><div className="page-shell grid gap-8 py-8 md:grid-cols-[auto_1fr_auto] md:items-center"><div className="flex items-center gap-4"><div className="relative size-14 overflow-hidden rounded-full border border-[#d6a642]/30"><Image src="/fsPhoto.webp" alt="Portrait of Dr. Ferdous Saleheen" fill sizes="56px" className="object-cover" /></div><div><strong className="block text-sm font-medium">Dr. Ferdoush Saleheen</strong><span className="text-xs text-[#858178]">PhD · FCILT</span></div></div><p className="max-w-2xl text-sm leading-6 text-[#99958c] md:border-l md:border-white/10 md:pl-8">Supply-chain and logistics specialist, academic, researcher, co-editor of an industry-driven SCM volume, and author of a separate work of Qur’anic reflection.</p><Link href="/en/about" className="inline-flex items-center gap-2 text-sm text-[#d6a642]">Read profile <ArrowRight className="size-4" /></Link></div></section>

      <HomePhotoCarousel locale="en" />

      <section id="professional-journey" className="relative overflow-hidden border-b border-white/[0.06] py-24 md:py-32"><div className="page-shell"><div className="mb-14 grid gap-6 md:grid-cols-[1fr_.72fr] md:items-end"><div><span className="eyebrow mb-5">Professional journey</span><h2 className="section-title">From industry leadership to <span className="gold-text">teaching and research</span></h2></div><p className="max-w-lg text-base leading-7 text-[#918d84] md:justify-self-end">More than two decades across supply chain, logistics, corporate transformation, and higher education in Asia and the Gulf.</p></div><div className="grid overflow-hidden rounded-[2rem] border border-white/[0.08] bg-[#0c0c0b] lg:grid-cols-[.82fr_1.18fr]">
        <div className="relative min-h-[34rem] bg-[#ecebea]"><Image src="/fsPhoto.webp" alt="Dr. Ferdous Saleheen, PhD, FCILT" fill sizes="(max-width: 1024px) 100vw, 42vw" className="object-cover object-top" /><div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black via-black/45 to-transparent p-7 pt-28"><span className="text-xs uppercase tracking-[0.14em] text-[#e8bd64]">Current leadership</span><p className="mt-2 text-lg font-medium text-white">Head of Maritime Logistics &amp; SCM Department</p><p className="mt-1 text-sm text-white/60">Sharjah Maritime Academy · UAE</p></div></div>
      ...
      <PublicationsOverview locale="en" />
